...
function renderJoinedItem(bodyAs, renderBody, renderFooter) {
  return /*#__PURE__*/React.createElement(Flex.Item, {
    ...
    height: "0",
    shouldGrow: true
  }, renderBody()), /*#__PURE__*/React.createElement("footer", {
    style: topElementStyles
...
export const FixedContentTray = ({
  ...
  }, renderHeader())), shouldJoinBodyAndFooter ? renderJoinedItem(bodyAs, renderBody, renderFooter) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Flex.Item, {
    as: bodyAs,
    overflowX: "auto",
    height: "0",
    shouldGrow: true
