...
export const Controls = ({
  ...
  return /*#__PURE__*/React.createElement(Flex, {
    ...
    margin: "x-small",
    alignItems: "start"
  }, /*#__PURE__*/React.createElement(ShapeControls, {
    shape: settings.shape,
    onChange: shape => dispatch({
      type: actions.SET_SHAPE,
      payload: shape
    })
  }), /*#__PURE__*/React.createElement(RotationControls, {
    rotation: settings.rotation,
    onChange: rotation => dispatch({
      type: actions.SET_ROTATION,
      payload: rotation
    })
  }), /*#__PURE__*/React.createElement(ZoomControls, {
    scaleRatio: settings.scaleRatio,
    onChange: scaleRatio => dispatch({
