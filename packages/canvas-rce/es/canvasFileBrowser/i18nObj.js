...
import htmlEscape from './htmlEscape'; // add i18nliner's runtime extensions to the global I18n object
...
I18n.n = I18n.localizeNumber = (value, options = {}) => {
  const format = { ...(I18n.lookup('number.format') || {}),
...
Scope.prototype.currentLocale = I18n.currentLocale.bind(I18n); // shorthand
