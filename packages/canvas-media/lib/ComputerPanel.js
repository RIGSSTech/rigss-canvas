...
const ClosedCaptionPanel = /*#__PURE__*/_react.default.lazy(() => Promise.resolve().then(() => _interopRequireWildcard(require('./ClosedCaptionCreator'))));
...
function ComputerPanel({
  ...
  const [mediaTracksCheckbox, setMediaTracksCheckbox] = (0, _react.useState)(false);
  const [previewURL, setPreviewURL] = (0, _react.useState)(null);
  ...
  if (hasUploadedFile) {
    ...
    })), ((0, _utils.isVideo)(theFile.type) || (0, _utils.isAudio)(theFile.type)) && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_uiView.View, {
      display: "block",
