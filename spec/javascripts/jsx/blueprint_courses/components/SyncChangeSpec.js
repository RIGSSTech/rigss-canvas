...
test('displays the correct exception types', () => {
  ...
  equal(exceptionGroup.text(), 'Points changed exceptions:Default Programme - Course 1')
  exceptionGroup = $(exceptionGroups[1])
  equal(exceptionGroup.text(), 'Content changed exceptions:Default Programme - Course 5')
  exceptionGroup = $(exceptionGroups[2])
  equal(exceptionGroup.text(), 'Deleted content exceptions:Default Programme - Course 56')
