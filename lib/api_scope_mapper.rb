...
class ApiScopeMapper
  SCOPE_MAP = {
    ...
    accounts: {
      index: :accounts,
      manageable_accounts: :accounts,
      course_accounts: :accounts,
      show: :accounts,
      show_settings: :accounts,
      permissions: :accounts,
      sub_accounts: :accounts,
      terms_of_service: :accounts,
      help_links: :accounts,
      manually_created_courses_account: :accounts,
    ...
    blackout_dates: {
      index: :blackout_dates,
      show: :blackout_dates,
      new: :blackout_dates,
      create: :blackout_dates,
      update: :blackout_dates,
      destroy: :blackout_dates,
      bulk_update: :blackout_dates
    }.freeze,
    master_templates: {
    ...
    courses: {
      ...
      permissions: :courses,
      bulk_user_progress: :courses,
      dismiss_migration_limitation_msg: :courses
    }.freeze,
    content_imports: {
    ...
    eportfolios_api: {
      ...
      delete: :eportfolios,
      pages: :eportfolios,
      moderate: :eportfolios,
      moderate_all: :eportfolios,
      restore: :eportfolios
    }.freeze,
    epub_exports: {
      index: :epub_exports,
    ...
    external_tools: {
      ...
      all_visible_nav_tools: :external_tools,
      visible_course_nav_tools: :external_tools
    }.freeze,
    favorites: {
    ...
    outcome_imports_api: {
      ...
      created_group_ids: :outcome_imports
    }.freeze,
    outcome_results: {
    ...
    submissions_api: {
      ...
      show_anonymous: :submissions,
      create_file: :submissions,
      update: :submissions,
      update_anonymous: :submissions,
      ...
      rubric_comments_read_state: :submissions,
      mark_rubric_comments_read: :submissions,
      document_annotations_read_state: :submissions,
      mark_document_annotations_read: :submissions,
    ...
    quiz_submission_questions: {
      ...
      formatted_answer: :quiz_submission_questions,
    ...
    subscriptions_api: {
      create: :webhooks_subscriptions_for_plagiarism_platform,
      destroy: :webhooks_subscriptions_for_plagiarism_platform,
      show: :webhooks_subscriptions_for_plagiarism_platform,
      update: :webhooks_subscriptions_for_plagiarism_platform,
      index: :webhooks_subscriptions_for_plagiarism_platform
    }.freeze
  }.freeze
  ...
  RESOURCE_NAMES = {
    ...
    blackout_dates: -> { I18n.t('Blackout Dates') },
    ...
    eportfolios: -> { I18n.t('ePortfolios') },
    ...
    instaccess_tokens: -> { I18n.t('InstAccess tokens') },
    jwts: -> { I18n.t('JWTs') },
    ...
    users: -> { I18n.t('Users') },
    webhooks_subscriptions_for_plagiarism_platform: -> { I18n.t('Webhooks Subscriptions for Plagiarism Platform') }
  }.freeze
