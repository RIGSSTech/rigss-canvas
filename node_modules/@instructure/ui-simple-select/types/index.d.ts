...
export type SimpleSelectRenderLabel = React.ReactNode | ((...args: any[])=>any);

export type SimpleSelectSize = "small" | "medium" | "large";

export type SimpleSelectInteraction = "enabled" | "disabled" | "readonly";

export type SimpleSelectRenderEmptyOption = React.ReactNode | ((...args: any[])=>any);

export type SimpleSelectRenderBeforeInput = React.ReactNode | ((...args: any[])=>any);

export type SimpleSelectRenderAfterInput = React.ReactNode | ((...args: any[])=>any);

export interface SimpleSelectProps {
    /**
     * The form field label.
     */
    renderLabel: SimpleSelectRenderLabel;
    /**
     ...
     */
    interaction?: SimpleSelectInteraction;
    /**
     ...
     */
    renderEmptyOption?: SimpleSelectRenderEmptyOption;
    /**
     * Content to display before the text input. This will commonly be an icon.
     */
    renderBeforeInput?: SimpleSelectRenderBeforeInput;
    /**
     * Content to display after the text input. This content will replace the
     * default arrow icons.
     */
    renderAfterInput?: SimpleSelectRenderAfterInput;
    /**
