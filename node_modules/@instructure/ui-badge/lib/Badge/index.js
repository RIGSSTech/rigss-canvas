...
---
**/
var Badge = (_dec = (0, _testable.testable)(), _dec2 = (0, _themeable.themeable)(_theme.default, styles), _dec(_class = _dec2(_class = (_temp = _class2 = /*#__PURE__*/function (_Component) {
  (0, _inherits2.default)(Badge, _Component);

  var _super = (0, _createSuper2.default)(Badge);
  ...
  function Badge(props) {
    ...
    _this._defaultId = (0, _uid.uid)('Badge');
    return _this;
  }
  ...
  (0, _createClass2.default)(Badge, [{
    ...
    value: function renderBadge() {
      ...
      return /*#__PURE__*/_react.default.createElement(_View.View, {
        ...
        className: (0, _classnames2.default)((_classnames = {}, (0, _defineProperty2.default)(_classnames, styles.root, true), (0, _defineProperty2.default)(_classnames, styles[type], type), (0, _defineProperty2.default)(_classnames, styles[variant], variant), (0, _defineProperty2.default)(_classnames, styles['positioned--top'], placement.indexOf('top') > -1), (0, _defineProperty2.default)(_classnames, styles['positioned--bottom'], placement.indexOf('bottom') > -1), (0, _defineProperty2.default)(_classnames, styles['positioned--start'], placement.indexOf('start') > -1), (0, _defineProperty2.default)(_classnames, styles['positioned--end'], placement.indexOf('end') > -1), (0, _defineProperty2.default)(_classnames, styles['positioned--center'], placement.indexOf('center') > -1), (0, _defineProperty2.default)(_classnames, styles.standalone, standalone), (0, _defineProperty2.default)(_classnames, styles.pulse, pulse), _classnames)),
   ...
   */
  countUntil: _propTypes.default.number,
  ...
  formatOverflowText: _propTypes.default.func,
  formatOutput: _propTypes.default.func,
