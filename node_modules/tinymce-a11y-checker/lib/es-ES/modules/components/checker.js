...
export default class Checker extends React.Component {
  ...
  render() {
    const rule = this.errorRule();
    const issueNumberMessage = "Problema " + (this.state.errorIndex + 1) + "/" + this.state.errors.length;
    return /*#__PURE__*/React.createElement(LiveAnnouncer, null, /*#__PURE__*/React.createElement(Tray, {
      "data-mce-component": true,
      label: "Verificador de accesibilidad",
    ...
    }, "Cerrar verificador de accesibilidad"), /*#__PURE__*/React.createElement(View, {
      as: "div",
      ...
      as: "h2",
      margin: "medium 0"
    }, " " + "Verificador de accesibilidad"), this.state.errors.length > 0 && /*#__PURE__*/React.createElement(View, {
      as: "div"
    ...
    }, /*#__PURE__*/React.createElement(ScreenReaderContent, null, "Por qu\xE9"))), /*#__PURE__*/React.createElement(Popover.Content, null, /*#__PURE__*/React.createElement(View, {
      padding: "medium",
      display: "block",
      width: "16rem"
    }, /*#__PURE__*/React.createElement(CloseButton, {
    ...
    }, "Close"), /*#__PURE__*/React.createElement(Text, null, /*#__PURE__*/React.createElement("p", null, rule.why()), /*#__PURE__*/React.createElement("p", null, rule.link && rule.link.length && /*#__PURE__*/React.createElement(ApplyTheme, {
      theme: {
        [Link.theme]: {
      ...
      margin: "0 small 0 0",
      "aria-label": "Previous"
    }, "Previo"), /*#__PURE__*/React.createElement(Button, {
      onClick: () => this.nextError()
    }, "Siguiente")), /*#__PURE__*/React.createElement(GridCol, {
      width: "auto"
    }, /*#__PURE__*/React.createElement(Button, {
      type: "submit",
      variant: "primary",
      disabled: !this.state.formStateValid
    }, "Aplicar"))))))), this.state.errors.length === 0 && !this.state.checking && /*#__PURE__*/React.createElement(View, null, /*#__PURE__*/React.createElement(Text, null, /*#__PURE__*/React.createElement("p", null, "No se han detectado problemas de accesibilidad.")), /*#__PURE__*/React.createElement(PlaceholderSVG, null)), this.state.checking && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(LiveMessage, {
      message: "Comprobando problemas de accesibilidad",
      "aria-live": "polite"
    }), /*#__PURE__*/React.createElement(Spinner, {
      title: "Comprobando problemas de accesibilidad",
      margin: "medium auto"
    })))));
  }
