...
var _default = {
  ...
  form: () => [{
    label: "Acci\xF3n a realizar:",
    dataKey: "action",
    options: [["nothing", "Dejar sin cambios"], ["elem", "Fijar jerarqu\xEDa de t\xEDtulos"], ["modify", "Eliminar estilo del t\xEDtulo"]]
  }],
  update: (elem, data) => {
  ...
  message: () => "Los niveles de los t\xEDtulos no deben omitirse.",
  why: () => "Los usuarios detectados navegan r\xE1pido por las p\xE1ginas web, buscando t\xEDtulos grandes o en negrita. Los usuarios del lector de pantalla solo utilizan los encabezados para una comprensi\xF3n contextual. Los encabezados deben tener la estructura apropiada.",
