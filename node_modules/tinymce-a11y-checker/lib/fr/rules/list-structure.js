...
var _default = {
  ...
  form: () => [{
    label: "Pr\xE9senter sous forme de liste",
    checkbox: true,
  ...
  message: () => "Les listes doivent \xEAtre pr\xE9sent\xE9es sous forme de listes.",
  why: () => "Lorsqu'on utilise des balises qui formatent visuellement les \xE9l\xE9ments sous forme de liste, mais qui n'indiquent pas la relation entre les listes, les utilisateurs peuvent avoir de la difficult\xE9 \xE0 naviguer dans l'information.",
  link: "https://www.w3.org/TR/2016/NOTE-WCAG20-TECHS-20161007/H48",
  linkText: () => "Apprenez-en davantage sur l\u2019utilisation des listes"
};
