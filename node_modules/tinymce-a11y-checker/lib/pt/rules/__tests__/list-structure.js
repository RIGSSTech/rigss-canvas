...
var _listStructure = _interopRequireDefault(require("../list-structure"));
...
describe("test", () => {
  test("returns true if not P element", () => {
    expect(_listStructure.default.test(document.createElement("div"))).toBeTruthy();
  });
  test("returns true if a normal paragraph", () => {
    expect(_listStructure.default.test(p1)).toBeTruthy();
  });
  test("returns true if previous node is also list-like", () => {
    expect(_listStructure.default.test(p3)).toBeTruthy();
  });
  test("returns false if ol-like", () => {
    expect(_listStructure.default.test(p2)).toBeFalsy();
  });
  test("returns true if ol-like but item label is more than 4 chars", () => {
    ...
    expect(_listStructure.default.test(p1)).toBeTruthy();
    expect(_listStructure.default.test(p2)).toBeTruthy();
    expect(_listStructure.default.test(p3)).toBeTruthy();
  });
...
describe("data", () => {
  test("returns the proper object", () => {
    expect(_listStructure.default.data(p2)).toMatchSnapshot();
  });
});
describe("form", () => {
  test("returns the proper object", () => {
    expect(_listStructure.default.form(p2)).toMatchSnapshot();
  });
});
describe("update", () => {
  test("returns same element", () => {
    expect(_listStructure.default.update(p1, {})).toBe(p1);
  });
  test("Resolves ordered items with followed by a period", () => {
    ...
    const newA = _listStructure.default.update(p1, (0, _objectSpread2.default)((0, _objectSpread2.default)({}, _listStructure.default.data(p1)), {}, {
      formatAsList: true
    }));

    expect(body.firstChild.tagName).toBe("OL");
    expect(body.firstChild.children.length).toBe(3);
    expect([...body.firstChild.children].every(child => child.textContent.trim() === "List")).toBeTruthy();
  });
  ...
  test("Replaces the ordered part of the list even when nested in an element", () => {
    ...
    expect(body.firstChild.tagName).toBe("OL");
    expect(body.firstChild.children.length).toBe(3);
    expect([...body.firstChild.children].every(child => child.textContent === "Text Text" && child.firstChild.tagName === "STRONG")).toBeTruthy();
  });
  test("Replaces bullets/numbers even when it is not in the first child", () => {
    ...
    expect(body.firstChild.tagName).toBe("OL");
    expect(body.firstChild.children.length).toBe(3);
    expect([...body.firstChild.children].every(child => child.textContent === "List" && child.firstChild.tagName === "DIV")).toBeTruthy();
  });
...
describe("rootNode", () => {
  test("returns the parentNode of an element", () => {
    expect(_listStructure.default.rootNode(p1).tagName).toBe("BODY");
  });
});
describe("message", () => {
  test("returns the proper message", () => {
    expect(_listStructure.default.message()).toMatchSnapshot();
  });
});
describe("why", () => {
  test("returns the proper why message", () => {
    expect(_listStructure.default.why()).toMatchSnapshot();
  });
});
describe("linkText", () => {
  test("returns the proper linkText message", () => {
    expect(_listStructure.default.linkText()).toMatchSnapshot();
  });
});