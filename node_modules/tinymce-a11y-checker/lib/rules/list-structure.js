...
var _default = {
  ...
  form: () => [{
    label: (0, _formatMessage.default)("Format as a list"),
    checkbox: true,
  ...
  message: () => (0, _formatMessage.default)("Lists should be formatted as lists."),
  why: () => (0, _formatMessage.default)("When markup is used that visually formats items as a list but does not indicate the list relationship, users may have difficulty in navigating the information."),
  link: "https://www.w3.org/TR/2016/NOTE-WCAG20-TECHS-20161007/H48",
  linkText: () => (0, _formatMessage.default)("Learn more about using lists")
};
