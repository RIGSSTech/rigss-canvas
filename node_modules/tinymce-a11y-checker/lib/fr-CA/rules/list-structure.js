...
var _default = {
  ...
  form: () => [{
    label: "Formater comme une liste",
    checkbox: true,
  ...
  message: () => "Les listes doivent \xEAtre format\xE9es comme une liste.",
  why: () => "Lorsque le langage de balisage est utilis\xE9 pour formater visuellement les \xE9l\xE9ments sous forme de liste, mais n'indique pas la relation de la liste, les utilisateurs peuvent avoir de la difficult\xE9 \xE0 naviguer dans l'information.",
  link: "https://www.w3.org/TR/2016/NOTE-WCAG20-TECHS-20161007/H48",
  linkText: () => "En apprendre davantage sur les listes"
};
