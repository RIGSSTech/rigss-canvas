...
class Checker extends _react.default.Component {
  ...
  render() {
    const rule = this.errorRule();
    const issueNumberMessage = "V\u1EA5n \u0111\u1EC1 " + (this.state.errorIndex + 1) + "/" + this.state.errors.length;
    return /*#__PURE__*/_react.default.createElement(_reactAriaLive.LiveAnnouncer, null, /*#__PURE__*/_react.default.createElement(_uiTray.Tray, {
      ...
      label: "Tr\xECnh Ki\u1EC3m Tra Kh\u1EA3 N\u0103ng Truy C\u1EADp",
    ...
    }, "\u0110\xF3ng Tr\xECnh Ki\u1EC3m Tra Kh\u1EA3 N\u0103ng Truy C\u1EADp"), /*#__PURE__*/_react.default.createElement(_uiView.View, {
      as: "div",
      ...
      as: "h2",
      margin: "medium 0"
    }, " " + "Tr\xECnh Ki\u1EC3m Tra Kh\u1EA3 N\u0103ng Truy C\u1EADp"), this.state.errors.length > 0 && /*#__PURE__*/_react.default.createElement(_uiView.View, {
      as: "div"
    ...
    }, /*#__PURE__*/_react.default.createElement(_uiA11yContent.ScreenReaderContent, null, "V\xEC Sao"))), /*#__PURE__*/_react.default.createElement(_uiPopover.Popover.Content, null, /*#__PURE__*/_react.default.createElement(_uiView.View, {
      padding: "medium",
      display: "block",
      width: "16rem"
    }, /*#__PURE__*/_react.default.createElement(_uiButtons.CloseButton, {
    ...
    }, "\u0110\xF3ng"), /*#__PURE__*/_react.default.createElement(_uiText.Text, null, /*#__PURE__*/_react.default.createElement("p", null, rule.why()), /*#__PURE__*/_react.default.createElement("p", null, rule.link && rule.link.length && /*#__PURE__*/_react.default.createElement(_uiThemeable.ApplyTheme, {
      theme: {
        [_uiLink.Link.theme]: {
      ...
      margin: "0 small 0 0",
      "aria-label": "Previous"
    }, "Tr\u01B0\u1EDBc"), /*#__PURE__*/_react.default.createElement(_uiButtons.Button, {
      onClick: () => this.nextError()
    }, "Ti\u1EBFp")), /*#__PURE__*/_react.default.createElement(_uiGrid.GridCol, {
      width: "auto"
    }, /*#__PURE__*/_react.default.createElement(_uiButtons.Button, {
      type: "submit",
      variant: "primary",
      disabled: !this.state.formStateValid
    }, "\xC1p D\u1EE5ng"))))))), this.state.errors.length === 0 && !this.state.checking && /*#__PURE__*/_react.default.createElement(_uiView.View, null, /*#__PURE__*/_react.default.createElement(_uiText.Text, null, /*#__PURE__*/_react.default.createElement("p", null, "Kh\xF4ng ph\xE1t hi\u1EC7n v\u1EA5n \u0111\u1EC1 kh\u1EA3 n\u0103ng ti\u1EBFp c\u1EADn.")), /*#__PURE__*/_react.default.createElement(_placeholderSvg.default, null)), this.state.checking && /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_reactAriaLive.LiveMessage, {
      message: "Ki\u1EC3m tra c\xE1c v\u1EA5n \u0111\u1EC1 kh\u1EA3 n\u0103ng ti\u1EBFp c\u1EADn",
      "aria-live": "polite"
    }), /*#__PURE__*/_react.default.createElement(_uiSpinner.Spinner, {
      title: "Ki\u1EC3m tra c\xE1c v\u1EA5n \u0111\u1EC1 kh\u1EA3 n\u0103ng ti\u1EBFp c\u1EADn",
      margin: "medium auto"
    })))));
  }
