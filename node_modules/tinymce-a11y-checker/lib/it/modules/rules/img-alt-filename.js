...
export default {
  ...
  form: () => [{
    label: "Cambia testo alternativo",
    dataKey: "alt",
    disabledIf: data => data.decorative
  }, {
    label: "Immagine decorativa",
    dataKey: "decorative",
    checkbox: true
  }],
  update: (elem, data) => {
  ...
  why: () => "Gli screen reader non possono determinare cosa viene visualizzato in un'immagine senza testo alternativo e i nomi file sono spesso stringhe di numeri e lettere senza senso che non descrivono il contesto o il significato.",
  link: "https://www.w3.org/TR/WCAG20-TECHS/F30.html",
  linkText: () => "Per saperne di pi\xF9 sull'utilizzo dei nomi dei file come testo alternativo"
};