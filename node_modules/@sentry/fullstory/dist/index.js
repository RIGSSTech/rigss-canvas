        ...
        Sentry.addGlobalEventProcessor(function (event, hint) {
            ...
            var getSentryUrl = function () {
                ...
                try {
                    ...
                    var dsn = (((_a = Sentry.getCurrentHub().getClient()) === null || _a === void 0 ? void 0 : _a.getOptions()) || {}).dsn;
                    if (!dsn) {
            ...
            var self = Sentry.getCurrentHub().getIntegration(SentryFullStory);
            // Run the integration ONLY when it was installed on the current Hub AND isn't a transaction
            if (self && event.type !== 'transaction' && _this.doesFullStoryExist()) {
                ...
                event.contexts = __assign(__assign({}, event.contexts), { fullStory: {
                ...
                FullStory.event('Sentry Error', __assign({ sentryUrl: getSentryUrl() }, getOriginalExceptionProperties(hint)));
            }
            return event;
        });
    };
...
module.exports = SentryFullStory;
